            ...
            <div className="col-12 col-sm-9 col-md-7 asset-overview__row_carousel">
              ...
              >
                <div>
                  ...
                  <div className="asset-overview__arrows">
                    <ButtonBack className="asset-overview__arrow">
                      <KeyboardArrowLeft className="asset-overview__icon" style={{fontSize: 35}}/>
                    </ButtonBack>
                    <ButtonNext className="asset-overview__arrow">
                      <KeyboardArrowRight className="asset-overview__icon" style={{fontSize: 35}}/>
                    </ButtonNext>
                  </div>
                </div>
              </CarouselProvider>
